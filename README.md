...
> **Work in progress.** This repository is public and under active development, but it is not yet feature-complete. Phase 1 (Claude Code ingestion + full-text search) is currently in progress.
